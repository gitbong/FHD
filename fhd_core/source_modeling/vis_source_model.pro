...
if keyword_set(model_delay_filter) then begin
  ...
  obs={code_version:obs.code_version,instrument:obs.instrument,obsname:obs.obsname,$
    ...
    n_vis:obs.n_vis,n_vis_in:obs.n_vis_in,n_vis_raw:obs.n_vis_raw,nf_vis:obs.nf_vis,primary_beam_area:obs.primary_beam_area,primary_beam_sq_area:obs.primary_beam_sq_area,$
    pol_names:obs.pol_names,$
