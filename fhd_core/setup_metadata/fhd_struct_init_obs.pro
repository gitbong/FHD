...
struct={code_version:String(code_version),instrument:String(instrument),obsname:String(obsname),$
    ...
    n_vis:Long(n_vis),n_vis_in:Long(n_vis_in),n_vis_raw:Long(n_vis_raw),nf_vis:Long(n_vis_arr),beam_integral:Ptrarr(4),beam2_integral:Ptrarr(4),pol_names:pol_names,$
